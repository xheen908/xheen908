...
| **Infrastructure** | Stateless Microservices, RESTful Architectures, Docker, Cloud-native Backends |
...
1. **Regulation is the spec.** I read the law, extract the data model, and build the validator before writing a single business logic line.
